...
<p>Effective date: March 1, 2020</p>

<p>Alert Ninja ("us", "we", or "our") operates the Alert Ninja mobile application (hereinafter referred to as the "Service").</p>
...
<p>Alert Ninja uses the collected data for various purposes:</p>    
<ul>
...
<p>Alert Ninja will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h2>Disclosure Of Data</h2>

<h3>Legal Requirements</h3>
<p>Alert Ninja may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of Alert Ninja</li>
...
<ul>
        <li>By email support@urbanpixels.com</li>
